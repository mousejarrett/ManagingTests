...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_Sign-In/input__txtPassword'), 'PDoKm2HePM0=')
...
WebUI.click(findTestObject('Page_Tenant Portal/h4_View Payment History'))

...
WebUI.click(findTestObject('Object Repository/Page_Home/a_Sign-In'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Tenant Portal/div_Schedule Walkthrough'), 0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Tenant Portal/div_Apply to Rent'), 0)

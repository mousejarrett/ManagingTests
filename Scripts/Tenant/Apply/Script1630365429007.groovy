...
WebUI.click(findTestObject('Object Repository/Page_Apply/h4_Tips for adding Application to email'))

WebUI.click(findTestObject('Object Repository/Page_Apply/h3_Once you have completed the application,_820c59'))

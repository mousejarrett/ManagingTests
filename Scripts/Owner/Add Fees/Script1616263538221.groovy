...
WebUI.click(findTestObject('Object Repository/Page_Owner Portal/h4_Add Fees'))

WebUI.click(findTestObject('Object Repository/Page_Add Additional Fees/button_Add Fee'))

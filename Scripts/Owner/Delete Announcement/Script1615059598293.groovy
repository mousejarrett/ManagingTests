...
WebUI.click(findTestObject('Object Repository/Page_Owner Portal/h4_Delete an Announcement'))

WebUI.click(findTestObject('Page_Delete Announcements/DeleteTestElement'))

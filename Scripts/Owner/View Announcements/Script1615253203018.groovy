...
WebUI.click(findTestObject('Object Repository/Page_Owner Portal/h4_View Announcements'))

WebUI.click(findTestObject('Object Repository/Page_Announcements/button_3'))

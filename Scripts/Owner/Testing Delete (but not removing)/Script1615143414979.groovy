...
WebUI.click(findTestObject('Object Repository/Page_Owner Portal/h4_Delete a Listing'))

WebUI.click(findTestObject('Object Repository/Page_Delete Listings/div_image container test'))

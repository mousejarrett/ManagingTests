...
WebUI.click(findTestObject('Object Repository/Page_Update Listing/button_Update Listing'))

WebUI.click(findTestObject('Object Repository/Page_View Listing/h5_600'))

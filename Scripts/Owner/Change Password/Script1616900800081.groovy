...
WebUI.click(findTestObject('Object Repository/Page_Sign-In/div_Sign-in Successful You will be redirect_4ef2c0'))
...
WebUI.click(findTestObject('Object Repository/Page_Owner Portal/h4_Change Password'))

WebUI.click(findTestObject('Object Repository/Page_Change Password/div_Current Password New Password New Passw_a1dd9a'))
